...
**
	...
	public static boolean isValidUser(String user, String password) throws SQLException{
		...
		ResultSet resultSet =statement.executeQuery("SELECT COUNT(*)FROM PEOPLE WHERE USER_ID = '"+ user333 +"' AND PASSWORD='" + password333 + "'"); /* BAD - user input should always be sanitized */
